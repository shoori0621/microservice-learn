...
func (c *catalogueClient) GetBook(ctx context.Context, in *GetBookRequest, opts ...grpc.CallOption) (*GetBookResponse, error) {
	...
	err := c.cc.Invoke(ctx, Catalogue_GetBook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCatalogueServer must be embedded to have
...
func RegisterCatalogueServer(s grpc.ServiceRegistrar, srv CatalogueServer) {
	// If the following call pancis, it indicates UnimplementedCatalogueServer was
